...
Modern Swift/SwiftUI development toolkit with TCA support for GitHub Copilot. Part of the **SwiftAgent** project. Provides 12 specialized agents and 18 comprehensive skills for planning, implementing, testing, and shipping production iOS/macOS applications.
...
**Sosumi MCP Server** — Optional for Apple documentation lookup. Agents can use this to verify modern API usage (2025). Configure in your Copilot MCP settings if available.

## Getting Started

1. **Copy** the `.github/agents/` and `.github/skills/` folders to your project
2. **Build a feature** by selecting agents in Copilot (start with `swift-architect` for new features)
...
```bash
# From the SwiftAgent root directory
cp -r .github/agents /path/to/your/project/.github/
cp -r .github/skills /path/to/your/project/.github/
cp .github/copilot-instructions.md /path/to/your/project/.github/
```

Agents will appear in the Copilot GUI agent selector.

### Configuration

Optional: Configure the **Sosumi MCP Server** for Apple documentation lookup.
...
Report issues or suggest features at the [GitHub repository](https://github.com/johnrogers/swift-agent/issues).
